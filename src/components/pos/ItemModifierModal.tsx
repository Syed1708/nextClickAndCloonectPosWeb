...
const EXCLUSIONS = [
  'Sans Oignon (No Onions)',
  'Sans Cornichon (No Pickles)',
  'Sans Tomate (No Tomato)',
  'Sans Sauce (No Sauce)',
];

const PAID_EXTRAS = [
  { label: 'Extra Fromage (+€1.00)', price: 1.0 },
  { label: 'Extra Bacon (+€1.50)', price: 1.5 },
  { label: 'Double Steack (+€2.50)', price: 2.5 },
  { label: 'Sauce à part (On Side)', price: 0.0 },
];

const COOKING_PRESETS = ['Saignant (Rare)', 'À Point (Medium)', 'Bien Cuit (Well Done)'];
...
export default function ItemModifierModal({
  ...
  // Calculate extra cost for paid suppléments
        ...
        <div className="flex-1 overflow-y-auto space-y-5 pr-1 text-xs">
          ...
          {selectedNotes.length > 0 && (
            <div className="pt-2 border-t border-zinc-800 space-y-1">
              <span className="text-[10px] text-zinc-500 font-bold uppercase">Active Notes:</span>
